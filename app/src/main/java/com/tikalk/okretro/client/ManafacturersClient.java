...
public class ManafacturersClient {
    private static final String BASE_URL = "https://api.edmunds.com/api/";
      ...
      public ManafacturersClient()
    {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(BASE_URL).client( ClientSupplier.getOkHttpClient())  .addConverterFactory(GsonConverterFactory.create())
                .build();
